...
(function ($) {
    ...
    $('[data-countdown]').each(function () {
        ...
        $(this).countdown(finalDate, function (event) {
            $(this).html(event.strftime(
                '<div class="row"><div class="col countdown-item"><h2>%-D</h2><h5>روز</h5></div><div class="col countdown-item"><h2>%H</h2><h5>ساعت</h5></div><div class="col countdown-item"><h2>%M</h2><h5>دقیقه</h5></div><div class="col countdown-item"><h2>%S</h2><h5>ثانیه</h5></div></div>'
            ));
        });
    });
    ...
    // مقدار فعلی رو بگیر
    let quantityInput = $(this).closest(".shop-cart-qty").children(".quantity");
    let currentValue = parseInt(quantityInput.val()); // مطمئن شو که عدد هست

    // مقدار رو یکی زیاد کن
    quantityInput.val(currentValue + 1);

    // اگر دکمه minus قبلا غیرفعال بوده، دوباره فعالش کن
    $(this).closest(".shop-cart-qty").children(".minus-btn").removeAttr("disabled");
});
...
$(".minus-btn").on("click", function () {
    ...
    // فقط اگر مقدار بیشتر از ۱ هست، کم کن
    if (currentValue > 1) {
        quantityInput.val(currentValue - 1);
        // اگر مقدار به ۱ رسید، دکمه minus رو غیرفعال کن
        if (currentValue - 1 === 1) {
            $(this).attr("disabled", "disabled");
        }
    }
    // اگر همش ۱ بود، کاری نکن و دکمه غیرفعال بمونه
});
    ...
    // invoice print
    $('.invoice-print-btn').on('click', function () {
